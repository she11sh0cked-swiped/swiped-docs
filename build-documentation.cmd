...
pandoc --fail-if-warnings --lua-filter ../pandoc/filters/date.lua --lua-filter ../pandoc/filters/pandoc-gls/pandoc-gls.lua --template ../pandoc/templates/pandoc-latex-template/eisvogel.tex --number-sections --listings --pdf-engine=xelatex -V mainfont="Segoe UI Emoji" -V monofont="Fira Code" -o _documentation.pdf ../src/documentation.md
